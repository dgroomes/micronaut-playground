...
* [x] DONE Remove the ID from the observations table. I often use tables without IDs. What changes do I have to make to the app
...
* [x] DONE Write a hand-written SQL query. I often write hand-written SQL queries to do aggregations and sometimes complex operations
...
* [x] DONE Clean up the build.gradle.kts file. The explicit version numbers should not be needed.
* [x] DONE The logging output is a bit of a mess. This doesn't make for an obvious demo. Demos should speak for themselves.
